...
import TVCategory from '../screens/TVCategory';

import ScrollableTabView, { ScrollableTabBar, } from 'react-native-scrollable-tab-view';

export default class TVHome extends Component {
  ...
  _renderCategoryView = (v, i) => {
    return <TVCategory key = {i} tabLabel = {v.Name} category = {v} onPressItem = {this._onPressItem}/>
  }
  ...
  componentDidMount(){
    fetch(
      'http://api.tinngan.vn/Tinngan.svc/getCategoryRadioNew',{
        headers: {
          'user':'tinngan',
